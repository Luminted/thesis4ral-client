                ...
                <div className="help">
                    <div  className="help__panel">
                        ...
                        <div className="help__title">
                           ...
                           <p> To place a card in your hand, drag it over to the area above your name and release it. If you release the card over one that is already in your hand, then it will be placed as the next one in your hand.</p>
