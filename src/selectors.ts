...
export const selectClientHandById = (clientId: TMaybeNull<string>) => (state: TRootState) => state.gameState.hands.find((hand) => hand.clientId === clientId) || null;
...
export const selectClientSeatId = (clientId: TMaybeNull<string>) => (state: TRootState) => {
