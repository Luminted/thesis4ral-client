import { IAddCardVerb, IFlipVerb, IGrabFromHandVerb, IPutInHandVerb, IPutOnTable, IReorderHandVerb } from "./cardVerbs";
...
type TCardVerb = IAddCardVerb | IFlipVerb | IGrabFromHandVerb | IPutInHandVerb | IPutOnTable | IReorderHandVerb;
